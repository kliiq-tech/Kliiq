        ...
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-surface/20 border border-gray-200 dark:border-white/10 rounded-xl overflow-hidden shadow-sm dark:shadow-none">
                ...
                <div className="divide-y divide-gray-100 dark:divide-white/5">
                    {softwareList.map((sw) => (
                        <div key={sw.name} className="p-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 rounded bg-gray-100 dark:bg-white/5 flex items-center justify-center overflow-hidden border border-gray-200 dark:border-white/10">
                                    <img
                            ...
                            <div className="flex items-center gap-6">
                                <div className="text-right">
                                    <div className={`text-xs font-medium px-2 py-1 rounded-full border ${sw.status === 'up-to-date' ? 'bg-green-500/10 text-green-600 dark:text-green-400 border-green-500/20' :
                                ...
                                <div className="text-xs text-text-muted font-mono w-24 text-right flex items-center justify-end gap-1">
